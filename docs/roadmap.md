...
> **As of 2026-07-26. v1.3.0-beta.6 PUBLISHED on npm (dist-tag `beta`); supersedes 1.3.0-beta.5.** The single source of "where Noir is right now." Update this whenever a slice ships or direction shifts — so no session loses the thread.
