...
- **11 `@noir-ai/*` packages (1.13.0 is the latest published), 26 builtin `noir-` skills (+ 1 integration), release registry** tracking versions from 1.5.0 through 1.13.0 (latest published) ([`AGENTS.md`](../../AGENTS.md), [`docs/roadmap/releases.md`](releases.md)).
