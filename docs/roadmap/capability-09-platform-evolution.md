...
- **11 `@noir-ai/*` packages at 1.6.0, 33 builtin `noir-` skills (+ 1 integration), release registry** tracking 1.5.0/1.6.0/1.6.0-beta.1 ([`AGENTS.md`](../../AGENTS.md), [`docs/roadmap/releases.md`](releases.md)).
