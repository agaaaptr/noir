...
> **As of 2026-08-06. `1.8.0` is `latest` on npm; `1.8.0-beta.1` is `beta`.** Source version is **`1.9.0`** (home consolidation — grouped menu + `noir palette` + TUI bridge). All 11 `@noir-ai/*` packages at `1.9.0`. Next milestone: the **v2 orchestrator TUI** (Archetype B — research).
