...
- **Automated ambiguity/missing-requirement detection in clarify:** ✅ **Shipped (2026-08-11, c4-research-grounding).** Clarify gating: `openQuestions` blocks clarify→spec (`--force`/`--skip` escape); `writeClarifications` artifact writer (`.noir/clarifications/<id>-<slug>.md`). — Spec: `2026-08-11-c4-research-grounding-design.md`.
