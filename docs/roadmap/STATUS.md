...
- `c4-verify-gate-recovery` (next implementation slice: evidence-backed verify gate, block-and-offer-recovery, HARD/SOFT tiering, conflict-seam recovery, document-phase wiring — `docs/internal/specs/2026-08-11-c4-verify-gate-recovery-design.md`). `c4-surface-wiring` shipped 2026-08-11.
