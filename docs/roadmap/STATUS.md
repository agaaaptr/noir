...
- `c4-research-grounding` (next implementation slice: soft research sub-step + `noir-research` skill + clarify artifact — `docs/internal/specs/2026-08-11-c4-research-grounding-design.md`). `c4-surface-wiring` + `c4-verify-gate-recovery` shipped 2026-08-11.
