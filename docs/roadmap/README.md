...
- **Decisions of record:** `docs/decisions/` (ADR `0001`…`0013`).
...
| 3 | [Built-in Skill System](capability-03-builtin-skill-system.md) | Completed — 27 builtins + registry + quality gate + evals | High |
...
| 5 | [Runtime Infrastructure & Local Daemon](capability-05-runtime-infrastructure.md) | Shipped — per-project records + HTTP auth + configured port | Medium |
