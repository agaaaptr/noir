...
### Added
- `releases.md` — migrated the shipped-status, release history, version targets, and deferred-features content from the former `docs/roadmap.md` (grounded to the 1.6.0 reality).
...
### Removed
- `docs/roadmap.md` (old) — superseded by `docs/roadmap/` + `releases.md` + `backlog.md`; external references updated.
