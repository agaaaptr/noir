...
| `@noir-ai/skills` | The native builtin skill pack (27 builtins + 1 integration = 28 skills) + a copy-and-validate compiler with a structural quality gate. Emits host-shaped `noir-*` artifacts: Claude `SKILL.md` files or Cursor `.mdc` rules. |
