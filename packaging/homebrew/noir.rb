...
#
# `url`/`sha256`/`version` are the REAL values from the 1.15.0 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.15.0.tgz"
  sha256 "ef7f6c09af1860203dafab2c827384cc209381dd21c8316637ee911312b41961"
  version "1.15.0"
  license "MIT"
