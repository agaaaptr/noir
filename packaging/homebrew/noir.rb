...
#
# `url`/`sha256`/`version` are the REAL values from the 1.7.2 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.7.2.tgz"
  sha256 "27fb864f43328a98aca6c0d02c362cb86482cd3b995066e13ec6e7bff5c56b83"
  version "1.7.2"
  license "MIT"
