...
#
# `url`/`sha256`/`version` are the REAL values from the 1.7.1 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.7.1.tgz"
  sha256 "59b12f39cf5354dc559843b38a06e350cda0fc32b3d39dc6fefbfe3d76ca56ee"
  version "1.7.1"
  license "MIT"
