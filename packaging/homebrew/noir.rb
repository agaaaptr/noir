...
#
# `url`/`sha256`/`version` are the REAL values from the 1.10.1 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.10.1.tgz"
  sha256 "edec99b248767ac7f6ac318e7609252896e000e1df969997fbf42e54ad2c3247"
  version "1.10.1"
  license "MIT"
