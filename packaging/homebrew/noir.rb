...
#
# `url`/`sha256`/`version` are the REAL values from the 1.11.0 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.11.0.tgz"
  sha256 "6c29f310624699c2344778489983b293624058b01544d72bbb840c89e34bd3da"
  version "1.11.0"
  license "MIT"
