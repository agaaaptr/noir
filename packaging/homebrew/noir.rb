...
#
# `url`/`sha256`/`version` are the REAL values from the 1.16.0 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.16.0.tgz"
  sha256 "c5b38d00be146e6755e56c636e15b97d1e9737de19ebb3cd0692125179171688"
  version "1.16.0"
  license "MIT"
