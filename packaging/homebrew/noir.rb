...
#
# `url`/`sha256`/`version` are the REAL values from the 1.11.2 npm tarball
...
class Noir < Formula
  ...
  url "https://registry.npmjs.org/@noir-ai/cli/-/cli-1.11.2.tgz"
  sha256 "b8d68bfead4877655d275cd32d1dc4c02dc1a69841e81eddd9441e6b86c9dd6e"
  version "1.11.2"
  license "MIT"
